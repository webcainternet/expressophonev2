<?php
class ControllerCommonsColumnLeft extends Controller {
	public function index() {
		$this->language->load('commons/column_left');
		...
		// Language
		$data['action'] = $this->url->link('commons/column_left/language', '', $this->request->server['HTTPS']);
		...
		return $this->load->view('commons/column_left', $data);
	}
