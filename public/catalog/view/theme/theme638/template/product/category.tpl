	...
	<div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
	  <?php /* <h2><?php echo $heading_title; ?></h2> */ ?>
        <?php if ($thumb || $description) { ?>
            <div class="row">
                <?php if ($thumb) { ?>
                    <?php /* <div class="col-sm-3"><div class="image"><img src="<?php echo $thumb; ?>" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" class="img-thumbnail" /></div></div><br> */ ?>
                <?php } ?>
                <?php if ($description) { ?>
				...
				<div class="caption">
					...
					<?php if(strlen($product['description']) > 2) {  ?>
						<div class="description-small">
							<?php if(strlen($product['description']) > 70) { echo substr($product['description'], 0, 70) . '..'; } else { echo $product['description']; } ?>
						</div>
